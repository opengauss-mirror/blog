...
img = "/zh/post/2022/title/img22.png" 

times = "12:30"

+++

# opengauss数据库-主从搭建<a name="ZH-CN_TOPIC_0000001186895102"></a> 

## 环境说明<a name="section126441641194310"></a>

![](figures/zh-cn_image_0000001197720014.png)
...
## 安装opengaussdb 数据库软件<a name="section13545115204914"></a>
...
-   创建XML配置文件
    ...
    如果是验证安装测试使用，建议修改其中的ip地址和hostname，
