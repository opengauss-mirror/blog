...
![](https://oss-emcsprod-public.modb.pro/image/editor/20230705-3de3549c-6534-41b8-b241-9658893ea91a.png)
检测防火墙是否关闭  
```
...
```
![](https://oss-emcsprod-public.modb.pro/image/editor/20230705-f3d683db-cd79-469a-aed8-6dc7bc877463.png)
...
![](https://oss-emcsprod-public.modb.pro/image/editor/20230705-5d01f3cf-722d-4ee3-89e5-45d5a90755de.png)
...
![](https://oss-emcsprod-public.modb.pro/image/editor/20230705-0d56cb7c-217f-4470-a0bc-2ec4fb0fba1f.png)  
...
![](https://oss-emcsprod-public.modb.pro/image/editor/20230705-25e38786-8582-4e3e-bf4e-fff241e86710.png)
...
`\dn`查看当前数据库有哪些schema  
`\dt`查看数据库中所有表
![](https://oss-emcsprod-public.modb.pro/image/editor/20230705-7d0a36a9-e5af-4ba5-b7e0-9de2371cf64f.png)
...
ALTER ROLE
```
![image.png](https://oss-emcsprod-public.modb.pro/image/editor/20230707-f65ba4a8-84fd-48b7-b797-95ba8966770c.png)
...
INSERT 0 1
```
![image.png](https://oss-emcsprod-public.modb.pro/image/editor/20230707-da4d7ee1-d8d0-4c41-be84-30e502527c3e.png)
...
CREATE SCHEMA
```
![image.png](https://oss-emcsprod-public.modb.pro/image/editor/20230707-fd01d684-efe1-4d8c-8b3d-eebfc066451d.png)
...
INSERT 0 1
```
![image.png](https://oss-emcsprod-public.modb.pro/image/editor/20230707-d889b1d2-ac17-40e9-92c2-6d8e2ea799c9.png)
...
==<font color=royalblue>走过路过点个赞</font>==
