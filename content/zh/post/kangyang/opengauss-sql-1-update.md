...
archives = "2020-07"
author = "kangyang"
summary = "陆续介绍openGauss数据库的各项核心技术，包括SQL引擎、优化器、存储引擎、事务处理、数据库安全等。本期介绍openGauss SQL引擎技术"
...
### 前言
    ...
    openGauss是高斯数据库系列产品之一，其开源版本已在今年6月30日推出。接下来将陆续向大家介绍openGauss数据库的各项核心技术，包括SQL引擎、优化器、存储引擎、事务处理、数据库安全等。本期开始介绍openGauss SQL引擎技术。
...
可以划分的关键字、标识符、操作符、常量等原子单位，如表1所示。
...
**图2  抽象语法树**
![图2](figures/zh-cn_image_0262916293.png)
