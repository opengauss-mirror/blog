...
<td class="cellrowborder"  width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p636317201667"><a name="p636317201667"></a><a name="p636317201667"></a>localhost=***.***.***.*** localport=5433 localservice=5434 remotehost=***.***.***.*** remoteport=5433 remoteservice=5434</p>
</td>
...
<td class="cellrowborder"  width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p6363172013611"><a name="p6363172013611"></a><a name="p6363172013611"></a>localhost=***.***.***.*** localport=5433 localservice=5434 remotehost=***.***.***.*** remoteport=5433 remoteservice=5434</p>
</td>
