...
```
$ gs_dbmind component opengauss_exporter --url postgresql://opengauss_exporter:opengauss_exporter123@***.***.***.***:5432/postgres --web.listen-address ***.***.***.*** --disable-https
```

#### 启动 reprocessing_exporter

```
$ gs_dbmind component reprocessing_exporter ***.***.***.*** 9090 --web.listen-address ***.***.***.*** --disable-https
```
...
+-------+-------------------------+--------------------------+---------------+--------------+
| 10309 |       os_cpu_usage      | ***.***.***.***              | 1653356410874 |     0.13     |
| 10310 |       os_cpu_usage      | ***.***.***.***              | 1653356425874 |     0.13     |
| 10311 |       os_cpu_usage      | ***.***.***.***              | 1653356440874 |     0.12     |
| 10312 |       os_cpu_usage      | ***.***.***.***              | 1653356455874 |     0.13     |
| 10313 |       os_cpu_usage      | ***.***.***.***              | 1653356470874 |     0.13     |
| 10314 |       os_cpu_usage      | ***.***.***.***              | 1653356485874 |     0.13     |
| 10315 |       os_cpu_usage      | ***.***.***.***              | 1653356500874 |     0.12     |
| 10316 |       os_cpu_usage      | ***.***.***.***              | 1653356515874 |     0.13     |
| 10317 |       os_cpu_usage      | ***.***.***.***              | 1653356530874 |     0.14     |
| 10318 |       os_cpu_usage      | ***.***.***.***              | 1653356545874 |     0.14     |
| 10319 |       os_cpu_usage      | ***.***.***.***              | 1653356560874 |     0.12     |
| 10320 |       os_cpu_usage      | ***.***.***.***              | 1653356575874 |     0.13     |
| 10549 |       os_mem_usage      | ***.***.***.***              | 1653356410874 |     0.46     |
| 10550 |       os_mem_usage      | ***.***.***.***              | 1653356425874 |     0.46     |
| 10551 |       os_mem_usage      | ***.***.***.***              | 1653356440874 |     0.46     |
| 10552 |       os_mem_usage      | ***.***.***.***              | 1653356455874 |     0.46     |
| 10553 |       os_mem_usage      | ***.***.***.***              | 1653356470874 |     0.46     |
| 10554 |       os_mem_usage      | ***.***.***.***              | 1653356485874 |     0.46     |
| 10555 |       os_mem_usage      | ***.***.***.***              | 1653356500874 |     0.46     |
| 10556 |       os_mem_usage      | ***.***.***.***              | 1653356515874 |     0.46     |
| 10557 |       os_mem_usage      | ***.***.***.***              | 1653356530874 |     0.46     |
| 10558 |       os_mem_usage      | ***.***.***.***              | 1653356545874 |     0.46     |
| 10559 |       os_mem_usage      | ***.***.***.***              | 1653356560874 |     0.46     |
| 10560 |       os_mem_usage      | ***.***.***.***              | 1653356575874 |     0.46     |
| 10788 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356410874 |     8.36     |
| 10789 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356425874 |     7.65     |
| 10790 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356440874 |     6.41     |
| 10791 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356455874 |     6.93     |
| 10792 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356470874 |     8.35     |
| 10793 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356485874 |     7.65     |
| 10794 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356500874 |     6.42     |
| 10795 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356515874 |     6.93     |
| 10796 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356530874 |     8.35     |
| 10797 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356545874 |     7.66     |
| 10798 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356560874 |     6.42     |
| 10799 | gaussdb_qps_by_instance | ***.***.***.***:5432         | 1653356575874 |     6.93     |
+-------+-------------------------+--------------------------+---------------+--------------+
(36 rows)
```
