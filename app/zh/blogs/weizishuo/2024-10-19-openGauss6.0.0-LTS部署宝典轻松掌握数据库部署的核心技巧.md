...
<img src = "./2024-10-19-openGauss 6.0.0-LTS部署宝典轻松掌握数据库部署的核心技巧-01.png">
...
<img src = "./2024-10-19-openGauss 6.0.0-LTS部署宝典轻松掌握数据库部署的核心技巧-02.png">

> `openGauss`**官网还提供了更加详细的数据库文档，供我们学习参考**
>
> **官方文档地址：**[https://docs-opengauss.osinfra.cn/zh/](https://docs-opengauss.osinfra.cn/zh/)

<img src = "./2024-10-19-openGauss 6.0.0-LTS部署宝典轻松掌握数据库部署的核心技巧-03.png">
...
Oct 16 12:28:29 openGuass systemd[1]: Starting firewalld - dynamic firewall daemon...
Oct 16 12:28:30 openGuass systemd[1]: Started firewalld - dynamic firewall daemon.
```
...
# 重启网卡即可生效
[root@openGuass ~]# nmcli connection down ens160
[root@openGuass ~]# nmcli connection up ens160
```
